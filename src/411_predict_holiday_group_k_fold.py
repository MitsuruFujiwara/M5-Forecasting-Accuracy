...
def main():
    ...
    print('load files...')
    sub_weekday = pd.read_csv('../output/submission_lgbm_group_k_fold_weekday.csv')
    sub_holiday = pd.read_csv('../output/submission_lgbm_group_k_fold_holiday.csv')
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_holiday_group_k_fold.csv'
    oof_file_name = '../output/oof_holiday_group_k_fold.csv'
    main()
