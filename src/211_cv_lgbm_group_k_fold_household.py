...
#==============================================================================
# Train LightGBM with group k-fold (household)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_group_k_fold_household_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_group_k_fold_household.png',
                        '../imp/feature_importance_lgbm_group_k_fold_household.csv')
...
def main(is_eval=False):
    with timer('Load Datasets'):
        # load feathers
        files = sorted(glob('../feats/f107_*.feather'))
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_group_k_fold_household.csv'
    oof_file_name = '../output/oof_lgbm_group_k_fold_household.csv'
    configs = json.load(open('../configs/211_cv_group_k_fold_household.json'))
