...
#==============================================================================
# Train LightGBM with group k-fold (holiday)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_group_k_fold_holiday_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_group_k_fold_holiday.png',
                        '../imp/feature_importance_lgbm_group_k_fold_holiday.csv')
...
def main(is_eval=False):
    with timer('Load Datasets'):
        # load feathers
        files = sorted(glob('../feats/f110_*.feather'))
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_group_k_fold_holiday.csv'
    oof_file_name = '../output/oof_lgbm_group_k_fold_holiday.csv'
    configs = json.load(open('../configs/220_cv_group_k_fold_holiday.json'))
