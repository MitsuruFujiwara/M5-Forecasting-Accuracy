...
#==============================================================================
# Train LightGBM with custom cv (hobbies)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_hobbies_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_cv_hobbies.png',
                        '../imp/feature_importance_lgbm_cv_hobbies.csv')
    ...
    to_json(configs, '../configs/308_train_hobbies.json')
...
if __name__ == '__main__':
    oof_file_name = '../output/oof_lgbm_cv_hobbies.csv'
    configs = json.load(open('../configs/209_cv_hobbies.json'))
