...
def main():
    ...
    # load oof files
    oof_foods = pd.read_csv('../output/oof_lgbm_foods.csv')
    oof_household = pd.read_csv('../output/oof_lgbm_household.csv')
    oof_hobbies = pd.read_csv('../output/oof_lgbm_hobbies.csv')
