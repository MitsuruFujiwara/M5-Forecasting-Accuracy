...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_group_k_fold_7days_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_group_k_fold_7days.png',
                        '../imp/feature_importance_lgbm_group_k_fold_7days.csv')
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_group_k_fold_7days.csv'
    oof_file_name = '../output/oof_lgbm_group_k_fold_7days.csv'
    configs = json.load(open('../configs/216_cv_group_k_fold_7days.json'))
