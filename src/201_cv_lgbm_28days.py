...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_28days_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_cv_28days.png',
                        '../imp/feature_importance_lgbm_cv_28days.csv')
    ...
    to_json(configs, '../configs/301_train_28days.json')
