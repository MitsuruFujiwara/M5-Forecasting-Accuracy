...
#==============================================================================
# Train LightGBM with group k-fold (14days)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_group_k_fold_14days_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_group_k_fold_14days.png',
                        '../imp/feature_importance_lgbm_group_k_fold_14days.csv')
