...
#==============================================================================
# Train LightGBM with 21days lag
#==============================================================================
...
#            'gpu_use_dp':True,
    ...
    # save model
    reg.save_model('../output/lgbm_21days.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_21days.png',
                        '../imp/feature_importance_lgbm_21days.csv')
...
if __name__ == "__main__":
    submission_file_name = "../output/submission_lgbm_21days.csv"
    oof_file_name = "../output/oof_lgbm_21days.csv"
    configs = json.load(open('../configs/302_train_21days.json'))
