...
#==============================================================================
# Train LightGBM with custom cv (diff)
#==============================================================================
...
#                'num_threads':-1
        ...
        # save model
        reg.save_model(f'../output/lgbm_diff_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_cv_diff.png',
                        '../imp/feature_importance_lgbm_cv_diff.csv')
    ...
    to_json(configs, '../configs/305_train_diff.json')
...
def main(debug=False):
    with timer("Load Datasets"):
        # load feathers
        files = sorted(glob('../feats/f105_*.feather'))
...
if __name__ == "__main__":
    oof_file_name = "../output/oof_lgbm_cv_diff.csv"
    configs = json.load(open('../configs/205_cv_diff.json'))
