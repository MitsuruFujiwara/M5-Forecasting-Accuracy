...
#            'gpu_use_dp':True,
    ...
    # save model
    reg.save_model('../output/lgbm_holiday.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_holiday.png',
                        '../imp/feature_importance_lgbm_holiday.csv')
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_holiday.csv'
    oof_file_name = '../output/oof_lgbm_holiday.csv'
    configs = json.load(open('../configs/310_train_holiday.json'))
