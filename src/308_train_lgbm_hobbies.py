...
#            'num_threads':-1
    ...
    # save model
    reg.save_model('../output/lgbm_hobbies.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_hobbies.png',
                        '../imp/feature_importance_lgbm_hobbies.csv')
...
if __name__ == "__main__":
    submission_file_name = "../output/submission_lgbm_hobbies.csv"
    oof_file_name = "../output/oof_lgbm_hobbies.csv"
    configs = json.load(open('../configs/308_train_hobbies.json'))
