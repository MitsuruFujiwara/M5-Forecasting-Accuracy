...
#==============================================================================
# Train LightGBM with group k-fold (weekday)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_group_k_fold_weekday_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_group_k_fold_weekday.png',
                        '../imp/feature_importance_lgbm_group_k_fold_weekday.csv')
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_group_k_fold_weekday.csv'
    oof_file_name = '../output/oof_lgbm_group_k_fold_weekday.csv'
    configs = json.load(open('../configs/219_cv_group_k_fold_weekday.json'))
