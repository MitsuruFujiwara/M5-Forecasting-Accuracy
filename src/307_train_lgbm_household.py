...
#            'gpu_use_dp':True,
    ...
    # save model
    reg.save_model('../output/lgbm_household.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_household.png',
                        '../imp/feature_importance_lgbm_household.csv')
...
if __name__ == '__main__':
    submission_file_name = '../output/submission_lgbm_household.csv'
    oof_file_name = '../output/oof_lgbm_household.csv'
    configs = json.load(open('../configs/307_train_household.json'))
