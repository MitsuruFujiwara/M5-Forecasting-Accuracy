...
#==============================================================================
# Train LightGBM with custom cv (weekday)
#==============================================================================
...
#                'gpu_use_dp':True,
        ...
        # save model
        reg.save_model(f'../output/lgbm_weekday_{n_fold}.txt')
    ...
    display_importances(feature_importance_df,
                        '../imp/lgbm_importances_cv_weekday.png',
                        '../imp/feature_importance_lgbm_cv_weekday.csv')
    ...
    to_json(configs, '../configs/309_train_weekday.json')
...
if __name__ == '__main__':
    oof_file_name = '../output/oof_lgbm_cv_weekday.csv'
    configs = json.load(open('../configs/217_cv_weekday.json'))
